...
def claim_bundling(idtoken_v2, adid, fid, serial, model, base_url):
	...
	data = {"advertisingId":adid,"appsflyerId":fid,"deviceId":serial,"deviceName":"Misaka Mikoto","deviceType":"Android","idToken":idtoken_v2,"modelNo":model,"serialNo":serial}
	headers = {}
	headers['user-agent'] = 'Mola/2.2.6.10 (Android 10; UA43T6500AKXXD)'
	headers['x-mola-version'] = 'Mola/2.2.6.10 (Android 10; UA43T6500AKXXD")'
	headers['content-type'] = 'application/json; charset=UTF-8'
...
def change_profile(bearer, base_url):
	...
	data = {"birthday":"","displayImage":"","displayName":"Misaka Mikoto","gender":"m","location":"","mobileNumber":"","user_language":""}
	headers = {}
	headers['user-agent'] = 'Mola/2.2.6.10 (Android 10; UA43T6500AKXXD)'
	headers['x-mola-version'] = 'Mola/2.2.6.10 (Android 10; UA43T6500AKXXD)'
	headers['authorization'] = f'Bearer {bearer}'
...
def generate_code(serial, model):
    ...
    data = {"deviceId":serial,"deviceName":"Polytron","deviceType":"AndroidTV","modelNo":model,"serialNo":serial}
    headers = {}
    headers['user-agent'] = 'Mola/2.2.6.10 (AndroidTV 10; UA43T6500AKXXD)'
    headers['x-mola-version'] = 'Mola/2.2.6.10 (AndroidTV 10; UA43T6500AKXXD)'
    headers['content-type'] = 'application/json; charset=UTF-8'
...
def checking_code(code):
    ...
    headers = {}
    headers['user-agent'] = 'Mola/2.0.2.13 (AndroidTV 10; UA43T6500AKXXD)'
    headers['x-mola-version'] = 'Mola/2.0.2.13 (AndroidTV 10; UA43T6500AKXXD)'
    headers['content-type'] = 'application/json; charset=UTF-8'
...
def get_proxy(method):
	...
	for i in range(2):
		subprocess.run(["python3", "proxy.py", "-p", method])
...
def generate_aktivasi(white, red, green):
	...
	print(f'  {white}Redeemed this activation code : {code} ')
